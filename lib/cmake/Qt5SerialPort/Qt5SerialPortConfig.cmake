...
set(Qt5SerialPort_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::SerialPort)
    ...
    set(_Qt5SerialPort_OWN_INCLUDE_DIRS
      "${_qt5SerialPort_install_prefix}/lib/QtSerialPort.framework"
      "${_qt5SerialPort_install_prefix}/lib/QtSerialPort.framework/Headers"
    )
    set(Qt5SerialPort_PRIVATE_INCLUDE_DIRS
        "${_qt5SerialPort_install_prefix}/lib/QtSerialPort.framework/Versions/5/Headers/5.15.2/"
        "${_qt5SerialPort_install_prefix}/lib/QtSerialPort.framework/Versions/5/Headers/5.15.2/QtSerialPort"
    )
    ...
    foreach(_module_dep ${_Qt5SerialPort_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt5SerialPort_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::SerialPort PROPERTY FRAMEWORK 1)
    ...
    _populate_SerialPort_target_properties(RELEASE "QtSerialPort.framework/QtSerialPort" "" TRUE)



    _populate_SerialPort_target_properties(DEBUG "QtSerialPort.framework/QtSerialPort" "" TRUE)
