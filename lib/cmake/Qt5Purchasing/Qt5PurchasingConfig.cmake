...
set(Qt5Purchasing_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::Purchasing)
    ...
    set(_Qt5Purchasing_OWN_INCLUDE_DIRS
      "${_qt5Purchasing_install_prefix}/lib/QtPurchasing.framework"
      "${_qt5Purchasing_install_prefix}/lib/QtPurchasing.framework/Headers"
    )
    set(Qt5Purchasing_PRIVATE_INCLUDE_DIRS
        "${_qt5Purchasing_install_prefix}/lib/QtPurchasing.framework/Versions/5/Headers/5.15.2/"
        "${_qt5Purchasing_install_prefix}/lib/QtPurchasing.framework/Versions/5/Headers/5.15.2/QtPurchasing"
    )
    ...
    foreach(_module_dep ${_Qt5Purchasing_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt5Purchasing_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Purchasing PROPERTY FRAMEWORK 1)
    ...
    _populate_Purchasing_target_properties(RELEASE "QtPurchasing.framework/QtPurchasing" "" TRUE)



    _populate_Purchasing_target_properties(DEBUG "QtPurchasing.framework/QtPurchasing" "" TRUE)
