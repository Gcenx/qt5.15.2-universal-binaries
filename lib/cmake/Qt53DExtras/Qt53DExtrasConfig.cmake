...
set(Qt53DExtras_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::3DExtras)
    ...
    set(_Qt53DExtras_OWN_INCLUDE_DIRS
      "${_qt53DExtras_install_prefix}/lib/Qt3DExtras.framework"
      "${_qt53DExtras_install_prefix}/lib/Qt3DExtras.framework/Headers"
    )
    set(Qt53DExtras_PRIVATE_INCLUDE_DIRS
        "${_qt53DExtras_install_prefix}/lib/Qt3DExtras.framework/Versions/5/Headers/5.15.2/"
        "${_qt53DExtras_install_prefix}/lib/Qt3DExtras.framework/Versions/5/Headers/5.15.2/Qt3DExtras"
    )
    ...
    foreach(_module_dep ${_Qt53DExtras_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt53DExtras_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::3DExtras PROPERTY FRAMEWORK 1)
    ...
    _populate_3DExtras_target_properties(RELEASE "Qt3DExtras.framework/Qt3DExtras" "" TRUE)



    _populate_3DExtras_target_properties(DEBUG "Qt3DExtras.framework/Qt3DExtras" "" TRUE)
