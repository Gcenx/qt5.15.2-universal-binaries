...
set(Qt53DQuickExtras_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::3DQuickExtras)
    ...
    set(_Qt53DQuickExtras_OWN_INCLUDE_DIRS
      "${_qt53DQuickExtras_install_prefix}/lib/Qt3DQuickExtras.framework"
      "${_qt53DQuickExtras_install_prefix}/lib/Qt3DQuickExtras.framework/Headers"
    )
    set(Qt53DQuickExtras_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuickExtras_install_prefix}/lib/Qt3DQuickExtras.framework/Versions/5/Headers/5.15.2/"
        "${_qt53DQuickExtras_install_prefix}/lib/Qt3DQuickExtras.framework/Versions/5/Headers/5.15.2/Qt3DQuickExtras"
    )
    ...
    foreach(_module_dep ${_Qt53DQuickExtras_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt53DQuickExtras_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::3DQuickExtras PROPERTY FRAMEWORK 1)
    ...
    _populate_3DQuickExtras_target_properties(RELEASE "Qt3DQuickExtras.framework/Qt3DQuickExtras" "" TRUE)



    _populate_3DQuickExtras_target_properties(DEBUG "Qt3DQuickExtras.framework/Qt3DQuickExtras" "" TRUE)
