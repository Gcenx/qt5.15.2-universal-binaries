...
set(Qt5Positioning_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::Positioning)
    ...
    set(_Qt5Positioning_OWN_INCLUDE_DIRS
      "${_qt5Positioning_install_prefix}/lib/QtPositioning.framework"
      "${_qt5Positioning_install_prefix}/lib/QtPositioning.framework/Headers"
    )
    set(Qt5Positioning_PRIVATE_INCLUDE_DIRS
        "${_qt5Positioning_install_prefix}/lib/QtPositioning.framework/Versions/5/Headers/5.15.2/"
        "${_qt5Positioning_install_prefix}/lib/QtPositioning.framework/Versions/5/Headers/5.15.2/QtPositioning"
    )
    ...
    foreach(_module_dep ${_Qt5Positioning_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt5Positioning_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Positioning PROPERTY FRAMEWORK 1)
    ...
    _populate_Positioning_target_properties(RELEASE "QtPositioning.framework/QtPositioning" "" TRUE)



    _populate_Positioning_target_properties(DEBUG "QtPositioning.framework/QtPositioning" "" TRUE)
