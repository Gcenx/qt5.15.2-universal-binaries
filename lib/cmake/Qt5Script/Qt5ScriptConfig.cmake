...
set(Qt5Script_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::Script)
    ...
    set(_Qt5Script_OWN_INCLUDE_DIRS
      "${_qt5Script_install_prefix}/lib/QtScript.framework"
      "${_qt5Script_install_prefix}/lib/QtScript.framework/Headers"
    )
    set(Qt5Script_PRIVATE_INCLUDE_DIRS
        "${_qt5Script_install_prefix}/lib/QtScript.framework/Versions/5/Headers/5.15.2/"
        "${_qt5Script_install_prefix}/lib/QtScript.framework/Versions/5/Headers/5.15.2/QtScript"
    )
    ...
    foreach(_module_dep ${_Qt5Script_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt5Script_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Script PROPERTY FRAMEWORK 1)
    ...
    _populate_Script_target_properties(RELEASE "QtScript.framework/QtScript" "" TRUE)



    _populate_Script_target_properties(DEBUG "QtScript.framework/QtScript" "" TRUE)
