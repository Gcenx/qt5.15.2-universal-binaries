...
set(Qt53DQuickInput_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::3DQuickInput)
    ...
    set(_Qt53DQuickInput_OWN_INCLUDE_DIRS
      "${_qt53DQuickInput_install_prefix}/lib/Qt3DQuickInput.framework"
      "${_qt53DQuickInput_install_prefix}/lib/Qt3DQuickInput.framework/Headers"
    )
    set(Qt53DQuickInput_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuickInput_install_prefix}/lib/Qt3DQuickInput.framework/Versions/5/Headers/5.15.2/"
        "${_qt53DQuickInput_install_prefix}/lib/Qt3DQuickInput.framework/Versions/5/Headers/5.15.2/Qt3DQuickInput"
    )
    ...
    foreach(_module_dep ${_Qt53DQuickInput_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt53DQuickInput_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::3DQuickInput PROPERTY FRAMEWORK 1)
    ...
    _populate_3DQuickInput_target_properties(RELEASE "Qt3DQuickInput.framework/Qt3DQuickInput" "" TRUE)



    _populate_3DQuickInput_target_properties(DEBUG "Qt3DQuickInput.framework/Qt3DQuickInput" "" TRUE)
