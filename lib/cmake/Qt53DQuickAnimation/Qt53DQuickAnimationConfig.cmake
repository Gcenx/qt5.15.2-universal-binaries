...
set(Qt53DQuickAnimation_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::3DQuickAnimation)
    ...
    set(_Qt53DQuickAnimation_OWN_INCLUDE_DIRS
      "${_qt53DQuickAnimation_install_prefix}/lib/Qt3DQuickAnimation.framework"
      "${_qt53DQuickAnimation_install_prefix}/lib/Qt3DQuickAnimation.framework/Headers"
    )
    set(Qt53DQuickAnimation_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuickAnimation_install_prefix}/lib/Qt3DQuickAnimation.framework/Versions/5/Headers/5.15.2/"
        "${_qt53DQuickAnimation_install_prefix}/lib/Qt3DQuickAnimation.framework/Versions/5/Headers/5.15.2/Qt3DQuickAnimation"
    )
    ...
    foreach(_module_dep ${_Qt53DQuickAnimation_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt53DQuickAnimation_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::3DQuickAnimation PROPERTY FRAMEWORK 1)
    ...
    _populate_3DQuickAnimation_target_properties(RELEASE "Qt3DQuickAnimation.framework/Qt3DQuickAnimation" "" TRUE)



    _populate_3DQuickAnimation_target_properties(DEBUG "Qt3DQuickAnimation.framework/Qt3DQuickAnimation" "" TRUE)
