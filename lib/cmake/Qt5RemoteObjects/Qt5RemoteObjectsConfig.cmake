...
set(Qt5RemoteObjects_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::RemoteObjects)
    ...
    set(_Qt5RemoteObjects_OWN_INCLUDE_DIRS
      "${_qt5RemoteObjects_install_prefix}/lib/QtRemoteObjects.framework"
      "${_qt5RemoteObjects_install_prefix}/lib/QtRemoteObjects.framework/Headers"
    )
    set(Qt5RemoteObjects_PRIVATE_INCLUDE_DIRS
        "${_qt5RemoteObjects_install_prefix}/lib/QtRemoteObjects.framework/Versions/5/Headers/5.15.2/"
        "${_qt5RemoteObjects_install_prefix}/lib/QtRemoteObjects.framework/Versions/5/Headers/5.15.2/QtRemoteObjects"
    )
    ...
    foreach(_module_dep ${_Qt5RemoteObjects_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt5RemoteObjects_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::RemoteObjects PROPERTY FRAMEWORK 1)
    ...
    _populate_RemoteObjects_target_properties(RELEASE "QtRemoteObjects.framework/QtRemoteObjects" "" TRUE)



    _populate_RemoteObjects_target_properties(DEBUG "QtRemoteObjects.framework/QtRemoteObjects" "" TRUE)
