...
set(Qt5DataVisualization_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::DataVisualization)
    ...
    set(_Qt5DataVisualization_OWN_INCLUDE_DIRS
      "${_qt5DataVisualization_install_prefix}/lib/QtDataVisualization.framework"
      "${_qt5DataVisualization_install_prefix}/lib/QtDataVisualization.framework/Headers"
    )
    set(Qt5DataVisualization_PRIVATE_INCLUDE_DIRS
        "${_qt5DataVisualization_install_prefix}/lib/QtDataVisualization.framework/Versions/5/Headers/5.15.2/"
        "${_qt5DataVisualization_install_prefix}/lib/QtDataVisualization.framework/Versions/5/Headers/5.15.2/QtDataVisualization"
    )
    ...
    foreach(_module_dep ${_Qt5DataVisualization_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt5DataVisualization_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::DataVisualization PROPERTY FRAMEWORK 1)
    ...
    _populate_DataVisualization_target_properties(RELEASE "QtDataVisualization.framework/QtDataVisualization" "" TRUE)



    _populate_DataVisualization_target_properties(DEBUG "QtDataVisualization.framework/QtDataVisualization" "" TRUE)
