...
set(Qt53DLogic_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::3DLogic)
    ...
    set(_Qt53DLogic_OWN_INCLUDE_DIRS
      "${_qt53DLogic_install_prefix}/lib/Qt3DLogic.framework"
      "${_qt53DLogic_install_prefix}/lib/Qt3DLogic.framework/Headers"
    )
    set(Qt53DLogic_PRIVATE_INCLUDE_DIRS
        "${_qt53DLogic_install_prefix}/lib/Qt3DLogic.framework/Versions/5/Headers/5.15.2/"
        "${_qt53DLogic_install_prefix}/lib/Qt3DLogic.framework/Versions/5/Headers/5.15.2/Qt3DLogic"
    )
    ...
    foreach(_module_dep ${_Qt53DLogic_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt53DLogic_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::3DLogic PROPERTY FRAMEWORK 1)
    ...
    _populate_3DLogic_target_properties(RELEASE "Qt3DLogic.framework/Qt3DLogic" "" TRUE)



    _populate_3DLogic_target_properties(DEBUG "Qt3DLogic.framework/Qt3DLogic" "" TRUE)
