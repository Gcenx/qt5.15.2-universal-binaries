...
macro(_populate_Feedback_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5Feedback_install_prefix}/lib/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Feedback)
    ...
    set(_Qt5Feedback_OWN_INCLUDE_DIRS
      "${_qt5Feedback_install_prefix}/lib/QtFeedback.framework"
      "${_qt5Feedback_install_prefix}/lib/QtFeedback.framework/Headers"
    )
    set(Qt5Feedback_PRIVATE_INCLUDE_DIRS
        "${_qt5Feedback_install_prefix}/lib/QtFeedback.framework/Versions/0/Headers/0.0.0/"
        "${_qt5Feedback_install_prefix}/lib/QtFeedback.framework/Versions/0/Headers/0.0.0/QtFeedback"
    )
    ...
    set_property(TARGET Qt5::Feedback PROPERTY FRAMEWORK 1)
    ...
    _populate_Feedback_target_properties(RELEASE "QtFeedback.framework/QtFeedback" "" TRUE)



    _populate_Feedback_target_properties(DEBUG "QtFeedback.framework/QtFeedback" "" TRUE)
