...
set(Qt5Quick3DRuntimeRender_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::Quick3DRuntimeRender)
    ...
    set(_Qt5Quick3DRuntimeRender_OWN_INCLUDE_DIRS
      "${_qt5Quick3DRuntimeRender_install_prefix}/lib/QtQuick3DRuntimeRender.framework"
      "${_qt5Quick3DRuntimeRender_install_prefix}/lib/QtQuick3DRuntimeRender.framework/Headers"
    )
    set(Qt5Quick3DRuntimeRender_PRIVATE_INCLUDE_DIRS
        "${_qt5Quick3DRuntimeRender_install_prefix}/lib/QtQuick3DRuntimeRender.framework/Versions/5/Headers/5.15.2/"
        "${_qt5Quick3DRuntimeRender_install_prefix}/lib/QtQuick3DRuntimeRender.framework/Versions/5/Headers/5.15.2/QtQuick3DRuntimeRender"
    )
    ...
    foreach(_module_dep ${_Qt5Quick3DRuntimeRender_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt5Quick3DRuntimeRender_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Quick3DRuntimeRender PROPERTY FRAMEWORK 1)
    ...
    _populate_Quick3DRuntimeRender_target_properties(RELEASE "QtQuick3DRuntimeRender.framework/QtQuick3DRuntimeRender" "" TRUE)



    _populate_Quick3DRuntimeRender_target_properties(DEBUG "QtQuick3DRuntimeRender.framework/QtQuick3DRuntimeRender" "" TRUE)
