...
set(Qt5Quick3DUtils_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::Quick3DUtils)
    ...
    set(_Qt5Quick3DUtils_OWN_INCLUDE_DIRS
      "${_qt5Quick3DUtils_install_prefix}/lib/QtQuick3DUtils.framework"
      "${_qt5Quick3DUtils_install_prefix}/lib/QtQuick3DUtils.framework/Headers"
    )
    set(Qt5Quick3DUtils_PRIVATE_INCLUDE_DIRS
        "${_qt5Quick3DUtils_install_prefix}/lib/QtQuick3DUtils.framework/Versions/5/Headers/5.15.2/"
        "${_qt5Quick3DUtils_install_prefix}/lib/QtQuick3DUtils.framework/Versions/5/Headers/5.15.2/QtQuick3DUtils"
    )
    ...
    foreach(_module_dep ${_Qt5Quick3DUtils_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt5Quick3DUtils_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Quick3DUtils PROPERTY FRAMEWORK 1)
    ...
    _populate_Quick3DUtils_target_properties(RELEASE "QtQuick3DUtils.framework/QtQuick3DUtils" "" TRUE)



    _populate_Quick3DUtils_target_properties(DEBUG "QtQuick3DUtils.framework/QtQuick3DUtils" "" TRUE)
