...
set(Qt5SerialBus_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::SerialBus)
    ...
    set(_Qt5SerialBus_OWN_INCLUDE_DIRS
      "${_qt5SerialBus_install_prefix}/lib/QtSerialBus.framework"
      "${_qt5SerialBus_install_prefix}/lib/QtSerialBus.framework/Headers"
    )
    set(Qt5SerialBus_PRIVATE_INCLUDE_DIRS
        "${_qt5SerialBus_install_prefix}/lib/QtSerialBus.framework/Versions/5/Headers/5.15.2/"
        "${_qt5SerialBus_install_prefix}/lib/QtSerialBus.framework/Versions/5/Headers/5.15.2/QtSerialBus"
    )
    ...
    foreach(_module_dep ${_Qt5SerialBus_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt5SerialBus_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::SerialBus PROPERTY FRAMEWORK 1)
    ...
    _populate_SerialBus_target_properties(RELEASE "QtSerialBus.framework/QtSerialBus" "" TRUE)



    _populate_SerialBus_target_properties(DEBUG "QtSerialBus.framework/QtSerialBus" "" TRUE)
