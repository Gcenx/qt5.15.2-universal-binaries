...
set(Qt53DAnimation_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::3DAnimation)
    ...
    set(_Qt53DAnimation_OWN_INCLUDE_DIRS
      "${_qt53DAnimation_install_prefix}/lib/Qt3DAnimation.framework"
      "${_qt53DAnimation_install_prefix}/lib/Qt3DAnimation.framework/Headers"
    )
    set(Qt53DAnimation_PRIVATE_INCLUDE_DIRS
        "${_qt53DAnimation_install_prefix}/lib/Qt3DAnimation.framework/Versions/5/Headers/5.15.2/"
        "${_qt53DAnimation_install_prefix}/lib/Qt3DAnimation.framework/Versions/5/Headers/5.15.2/Qt3DAnimation"
    )
    ...
    foreach(_module_dep ${_Qt53DAnimation_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt53DAnimation_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::3DAnimation PROPERTY FRAMEWORK 1)
    ...
    _populate_3DAnimation_target_properties(RELEASE "Qt3DAnimation.framework/Qt3DAnimation" "" TRUE)



    _populate_3DAnimation_target_properties(DEBUG "Qt3DAnimation.framework/Qt3DAnimation" "" TRUE)
