...
if (NOT TARGET Qt5::Svg)
    ...
    set(_Qt5Svg_OWN_INCLUDE_DIRS
      "${_qt5Svg_install_prefix}/lib/QtSvg.framework"
      "${_qt5Svg_install_prefix}/lib/QtSvg.framework/Headers"
    )
    set(Qt5Svg_PRIVATE_INCLUDE_DIRS
        "${_qt5Svg_install_prefix}/lib/QtSvg.framework/Versions/5/Headers/5.15.2/"
        "${_qt5Svg_install_prefix}/lib/QtSvg.framework/Versions/5/Headers/5.15.2/QtSvg"
    )
    ...
    set_property(TARGET Qt5::Svg PROPERTY FRAMEWORK 1)
    ...
    _populate_Svg_target_properties(RELEASE "QtSvg.framework/QtSvg" "" TRUE)



    _populate_Svg_target_properties(DEBUG "QtSvg.framework/QtSvg" "" TRUE)
