...
set(Qt5Quick3D_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::Quick3D)
    ...
    set(_Qt5Quick3D_OWN_INCLUDE_DIRS
      "${_qt5Quick3D_install_prefix}/lib/QtQuick3D.framework"
      "${_qt5Quick3D_install_prefix}/lib/QtQuick3D.framework/Headers"
    )
    set(Qt5Quick3D_PRIVATE_INCLUDE_DIRS
        "${_qt5Quick3D_install_prefix}/lib/QtQuick3D.framework/Versions/5/Headers/5.15.2/"
        "${_qt5Quick3D_install_prefix}/lib/QtQuick3D.framework/Versions/5/Headers/5.15.2/QtQuick3D"
    )
    ...
    foreach(_module_dep ${_Qt5Quick3D_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt5Quick3D_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Quick3D PROPERTY FRAMEWORK 1)
    ...
    _populate_Quick3D_target_properties(RELEASE "QtQuick3D.framework/QtQuick3D" "" TRUE)



    _populate_Quick3D_target_properties(DEBUG "QtQuick3D.framework/QtQuick3D" "" TRUE)
