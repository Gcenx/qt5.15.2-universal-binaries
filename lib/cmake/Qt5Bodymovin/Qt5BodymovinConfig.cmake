...
set(Qt5Bodymovin_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::Bodymovin)
    ...
    set(_Qt5Bodymovin_OWN_INCLUDE_DIRS
      "${_qt5Bodymovin_install_prefix}/lib/QtBodymovin.framework"
      "${_qt5Bodymovin_install_prefix}/lib/QtBodymovin.framework/Headers"
    )
    set(Qt5Bodymovin_PRIVATE_INCLUDE_DIRS
        "${_qt5Bodymovin_install_prefix}/lib/QtBodymovin.framework/Versions/5/Headers/5.15.2/"
        "${_qt5Bodymovin_install_prefix}/lib/QtBodymovin.framework/Versions/5/Headers/5.15.2/QtBodymovin"
    )
    ...
    foreach(_module_dep ${_Qt5Bodymovin_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt5Bodymovin_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Bodymovin PROPERTY FRAMEWORK 1)
    ...
    _populate_Bodymovin_target_properties(RELEASE "QtBodymovin.framework/QtBodymovin" "" TRUE)



    _populate_Bodymovin_target_properties(DEBUG "QtBodymovin.framework/QtBodymovin" "" TRUE)
