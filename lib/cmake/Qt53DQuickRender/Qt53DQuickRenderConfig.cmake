...
set(Qt53DQuickRender_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::3DQuickRender)
    ...
    set(_Qt53DQuickRender_OWN_INCLUDE_DIRS
      "${_qt53DQuickRender_install_prefix}/lib/Qt3DQuickRender.framework"
      "${_qt53DQuickRender_install_prefix}/lib/Qt3DQuickRender.framework/Headers"
    )
    set(Qt53DQuickRender_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuickRender_install_prefix}/lib/Qt3DQuickRender.framework/Versions/5/Headers/5.15.2/"
        "${_qt53DQuickRender_install_prefix}/lib/Qt3DQuickRender.framework/Versions/5/Headers/5.15.2/Qt3DQuickRender"
    )
    ...
    foreach(_module_dep ${_Qt53DQuickRender_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt53DQuickRender_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::3DQuickRender PROPERTY FRAMEWORK 1)
    ...
    _populate_3DQuickRender_target_properties(RELEASE "Qt3DQuickRender.framework/Qt3DQuickRender" "" TRUE)



    _populate_3DQuickRender_target_properties(DEBUG "Qt3DQuickRender.framework/Qt3DQuickRender" "" TRUE)
