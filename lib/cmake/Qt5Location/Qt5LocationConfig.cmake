...
set(Qt5Location_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::Location)
    ...
    set(_Qt5Location_OWN_INCLUDE_DIRS
      "${_qt5Location_install_prefix}/lib/QtLocation.framework"
      "${_qt5Location_install_prefix}/lib/QtLocation.framework/Headers"
    )
    set(Qt5Location_PRIVATE_INCLUDE_DIRS
        "${_qt5Location_install_prefix}/lib/QtLocation.framework/Versions/5/Headers/5.15.2/"
        "${_qt5Location_install_prefix}/lib/QtLocation.framework/Versions/5/Headers/5.15.2/QtLocation"
    )
    ...
    foreach(_module_dep ${_Qt5Location_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt5Location_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Location PROPERTY FRAMEWORK 1)
    ...
    set_property(TARGET Qt5::Location
                 ...
                 geoservices_esri;geoservices_here;geoservices_itemsoverlay;geoservices_mapbox;geoservices_mapboxgl;geoservices_osm;location-labs-plugin)
    set_property(TARGET Qt5::Location
    ...
    _populate_Location_target_properties(RELEASE "QtLocation.framework/QtLocation" "" TRUE)



    _populate_Location_target_properties(DEBUG "QtLocation.framework/QtLocation" "" TRUE)
