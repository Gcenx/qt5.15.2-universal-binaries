...
set(Qt5WebView_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::WebView)
    ...
    set(_Qt5WebView_OWN_INCLUDE_DIRS
      "${_qt5WebView_install_prefix}/lib/QtWebView.framework"
      "${_qt5WebView_install_prefix}/lib/QtWebView.framework/Headers"
    )
    set(Qt5WebView_PRIVATE_INCLUDE_DIRS
        "${_qt5WebView_install_prefix}/lib/QtWebView.framework/Versions/5/Headers/5.15.2/"
        "${_qt5WebView_install_prefix}/lib/QtWebView.framework/Versions/5/Headers/5.15.2/QtWebView"
    )
    ...
    foreach(_module_dep ${_Qt5WebView_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt5WebView_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::WebView PROPERTY FRAMEWORK 1)
    ...
    _populate_WebView_target_properties(RELEASE "QtWebView.framework/QtWebView" "" TRUE)



    _populate_WebView_target_properties(DEBUG "QtWebView.framework/QtWebView" "" TRUE)
