...
set(Qt53DQuick_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::3DQuick)
    ...
    set(_Qt53DQuick_OWN_INCLUDE_DIRS
      "${_qt53DQuick_install_prefix}/lib/Qt3DQuick.framework"
      "${_qt53DQuick_install_prefix}/lib/Qt3DQuick.framework/Headers"
    )
    set(Qt53DQuick_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuick_install_prefix}/lib/Qt3DQuick.framework/Versions/5/Headers/5.15.2/"
        "${_qt53DQuick_install_prefix}/lib/Qt3DQuick.framework/Versions/5/Headers/5.15.2/Qt3DQuick"
    )
    ...
    foreach(_module_dep ${_Qt53DQuick_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt53DQuick_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::3DQuick PROPERTY FRAMEWORK 1)
    ...
    _populate_3DQuick_target_properties(RELEASE "Qt3DQuick.framework/Qt3DQuick" "" TRUE)



    _populate_3DQuick_target_properties(DEBUG "Qt3DQuick.framework/Qt3DQuick" "" TRUE)
