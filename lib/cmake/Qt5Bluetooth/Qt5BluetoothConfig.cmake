...
set(Qt5Bluetooth_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::Bluetooth)
    ...
    set(_Qt5Bluetooth_OWN_INCLUDE_DIRS
      "${_qt5Bluetooth_install_prefix}/lib/QtBluetooth.framework"
      "${_qt5Bluetooth_install_prefix}/lib/QtBluetooth.framework/Headers"
    )
    set(Qt5Bluetooth_PRIVATE_INCLUDE_DIRS
        "${_qt5Bluetooth_install_prefix}/lib/QtBluetooth.framework/Versions/5/Headers/5.15.2/"
        "${_qt5Bluetooth_install_prefix}/lib/QtBluetooth.framework/Versions/5/Headers/5.15.2/QtBluetooth"
    )
    ...
    foreach(_module_dep ${_Qt5Bluetooth_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt5Bluetooth_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Bluetooth PROPERTY FRAMEWORK 1)
    ...
    _populate_Bluetooth_target_properties(RELEASE "QtBluetooth.framework/QtBluetooth" "" TRUE)



    _populate_Bluetooth_target_properties(DEBUG "QtBluetooth.framework/QtBluetooth" "" TRUE)
