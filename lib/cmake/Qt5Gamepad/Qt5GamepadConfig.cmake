...
set(Qt5Gamepad_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::Gamepad)
    ...
    set(Qt5Gamepad_PRIVATE_INCLUDE_DIRS
        "${_qt5Gamepad_install_prefix}/lib/QtGamepad.framework/Versions/5/Headers/5.15.2/"
        "${_qt5Gamepad_install_prefix}/lib/QtGamepad.framework/Versions/5/Headers/5.15.2/QtGamepad"
    )
    ...
    foreach(_module_dep ${_Qt5Gamepad_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt5Gamepad_FIND_VERSION_EXACT}
    ...
    _populate_Gamepad_target_properties(RELEASE "QtGamepad.framework/QtGamepad" "" TRUE)



    _populate_Gamepad_target_properties(DEBUG "QtGamepad.framework/QtGamepad" "" TRUE)
