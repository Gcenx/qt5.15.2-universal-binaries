...
set(Qt5Sensors_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::Sensors)
    ...
    set(_Qt5Sensors_OWN_INCLUDE_DIRS
      "${_qt5Sensors_install_prefix}/lib/QtSensors.framework"
      "${_qt5Sensors_install_prefix}/lib/QtSensors.framework/Headers"
    )
    set(Qt5Sensors_PRIVATE_INCLUDE_DIRS
        "${_qt5Sensors_install_prefix}/lib/QtSensors.framework/Versions/5/Headers/5.15.2/"
        "${_qt5Sensors_install_prefix}/lib/QtSensors.framework/Versions/5/Headers/5.15.2/QtSensors"
    )
    ...
    foreach(_module_dep ${_Qt5Sensors_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt5Sensors_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Sensors PROPERTY FRAMEWORK 1)
    ...
    _populate_Sensors_target_properties(RELEASE "QtSensors.framework/QtSensors" "" TRUE)



    _populate_Sensors_target_properties(DEBUG "QtSensors.framework/QtSensors" "" TRUE)
