...
macro(_populate_Versit_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5Versit_install_prefix}/lib/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Versit)
    ...
    set(_Qt5Versit_OWN_INCLUDE_DIRS
      "${_qt5Versit_install_prefix}/lib/QtVersit.framework"
      "${_qt5Versit_install_prefix}/lib/QtVersit.framework/Headers"
    )
    set(Qt5Versit_PRIVATE_INCLUDE_DIRS
        "${_qt5Versit_install_prefix}/lib/QtVersit.framework/Versions/0/Headers/0.0.0/"
        "${_qt5Versit_install_prefix}/lib/QtVersit.framework/Versions/0/Headers/0.0.0/QtVersit"
    )
    ...
    set_property(TARGET Qt5::Versit PROPERTY FRAMEWORK 1)
    ...
    _populate_Versit_target_properties(RELEASE "QtVersit.framework/QtVersit" "" TRUE)



    _populate_Versit_target_properties(DEBUG "QtVersit.framework/QtVersit" "" TRUE)
