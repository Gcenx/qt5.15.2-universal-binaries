...
if (NOT TARGET Qt5::Network)
    ...
    set(_Qt5Network_OWN_INCLUDE_DIRS
      "${_qt5Network_install_prefix}/lib/QtNetwork.framework"
      "${_qt5Network_install_prefix}/lib/QtNetwork.framework/Headers"
    )
    set(Qt5Network_PRIVATE_INCLUDE_DIRS
        "${_qt5Network_install_prefix}/lib/QtNetwork.framework/Versions/5/Headers/5.15.2/"
        "${_qt5Network_install_prefix}/lib/QtNetwork.framework/Versions/5/Headers/5.15.2/QtNetwork"
    )
    ...
    set_property(TARGET Qt5::Network PROPERTY FRAMEWORK 1)
    ...
    set_property(TARGET Qt5::Network PROPERTY INTERFACE_QT_ENABLED_FEATURES networkinterface;bearermanagement;dnslookup;ftp;gssapi;http;localserver;networkdiskcache;networkproxy;securetransport;socks5;ssl;udpsocket)
    set_property(TARGET Qt5::Network PROPERTY INTERFACE_QT_DISABLED_FEATURES dtls;opensslv11;ocsp;schannel;sctp;sspi)

    # Qt 6 forward compatible properties.
    set_property(TARGET Qt5::Network
                 PROPERTY QT_ENABLED_PUBLIC_FEATURES
                 networkinterface;bearermanagement;dnslookup;ftp;gssapi;http;localserver;networkdiskcache;networkproxy;securetransport;socks5;ssl;udpsocket)
    set_property(TARGET Qt5::Network
                 PROPERTY QT_DISABLED_PUBLIC_FEATURES
                 dtls;opensslv11;ocsp;schannel;sctp;sspi)
    set_property(TARGET Qt5::Network
                 PROPERTY QT_ENABLED_PRIVATE_FEATURES
                 corewlan;system-proxies)
    set_property(TARGET Qt5::Network
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 openssl;openssl-linked;libproxy;linux-netlink;netlistmgr)
    ...
    _populate_Network_target_properties(RELEASE "QtNetwork.framework/QtNetwork" "" TRUE)



    _populate_Network_target_properties(DEBUG "QtNetwork.framework/QtNetwork" "" TRUE)
