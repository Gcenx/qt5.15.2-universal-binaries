...
set(Qt5Nfc_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::Nfc)
    ...
    set(_Qt5Nfc_OWN_INCLUDE_DIRS
      "${_qt5Nfc_install_prefix}/lib/QtNfc.framework"
      "${_qt5Nfc_install_prefix}/lib/QtNfc.framework/Headers"
    )
    set(Qt5Nfc_PRIVATE_INCLUDE_DIRS
        "${_qt5Nfc_install_prefix}/lib/QtNfc.framework/Versions/5/Headers/5.15.2/"
        "${_qt5Nfc_install_prefix}/lib/QtNfc.framework/Versions/5/Headers/5.15.2/QtNfc"
    )
    ...
    foreach(_module_dep ${_Qt5Nfc_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt5Nfc_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Nfc PROPERTY FRAMEWORK 1)
    ...
    _populate_Nfc_target_properties(RELEASE "QtNfc.framework/QtNfc" "" TRUE)



    _populate_Nfc_target_properties(DEBUG "QtNfc.framework/QtNfc" "" TRUE)
