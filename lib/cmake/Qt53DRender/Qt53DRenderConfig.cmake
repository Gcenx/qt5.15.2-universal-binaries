...
set(Qt53DRender_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::3DRender)
    ...
    set(_Qt53DRender_OWN_INCLUDE_DIRS
      "${_qt53DRender_install_prefix}/lib/Qt3DRender.framework"
      "${_qt53DRender_install_prefix}/lib/Qt3DRender.framework/Headers"
    )
    set(Qt53DRender_PRIVATE_INCLUDE_DIRS
        "${_qt53DRender_install_prefix}/lib/Qt3DRender.framework/Versions/5/Headers/5.15.2/"
        "${_qt53DRender_install_prefix}/lib/Qt3DRender.framework/Versions/5/Headers/5.15.2/Qt3DRender"
    )
    ...
    foreach(_module_dep ${_Qt53DRender_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt53DRender_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::3DRender PROPERTY FRAMEWORK 1)
    ...
    _populate_3DRender_target_properties(RELEASE "Qt3DRender.framework/Qt3DRender" "" TRUE)



    _populate_3DRender_target_properties(DEBUG "Qt3DRender.framework/Qt3DRender" "" TRUE)
