...
set(Qt5Charts_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::Charts)
    ...
    set(_Qt5Charts_OWN_INCLUDE_DIRS
      "${_qt5Charts_install_prefix}/lib/QtCharts.framework"
      "${_qt5Charts_install_prefix}/lib/QtCharts.framework/Headers"
    )
    set(Qt5Charts_PRIVATE_INCLUDE_DIRS
        "${_qt5Charts_install_prefix}/lib/QtCharts.framework/Versions/5/Headers/5.15.2/"
        "${_qt5Charts_install_prefix}/lib/QtCharts.framework/Versions/5/Headers/5.15.2/QtCharts"
    )
    ...
    foreach(_module_dep ${_Qt5Charts_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt5Charts_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Charts PROPERTY FRAMEWORK 1)
    ...
    _populate_Charts_target_properties(RELEASE "QtCharts.framework/QtCharts" "" TRUE)



    _populate_Charts_target_properties(DEBUG "QtCharts.framework/QtCharts" "" TRUE)
